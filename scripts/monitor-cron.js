...
const firebaseConfig = {
  apiKey:
    process.env.FIREBASE_API_KEY || "AIzaSyDsONdN5q1vz5Gp6Irk0K7T4-GexuJ6Meo",
  authDomain:
    process.env.FIREBASE_AUTH_DOMAIN || "kendal-monitor.firebaseapp.com",
  projectId: process.env.FIREBASE_PROJECT_ID || "kendal-monitor",
  storageBucket:
    process.env.FIREBASE_STORAGE_BUCKET || "kendal-monitor.firebasestorage.app",
  messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || "769565947746",
  appId:
    process.env.FIREBASE_APP_ID || "1:769565947746:web:90ae2c85d894b0da44de3b",
